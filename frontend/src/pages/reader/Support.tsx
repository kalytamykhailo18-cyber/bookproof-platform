...
export function ReaderSupportPage() {
  ...
  const getTypeLabel = (type: DisputeType) => {
    const labels: Record<DisputeType, string> = {
      [DisputeType.AUTHOR_DISPUTE]: t('disputeTypes.authorDispute'),
      [DisputeType.AUTHOR_COMPLAINT]: t('disputeTypes.authorComplaint'),
      ...
      [DisputeType.POLICY_VIOLATION]: t('disputeTypes.policyViolation'),
            ...
            <div className="space-y-4">
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value={DisputeType.READER_COMPLAINT}>{t('issueTypes.generalComplaint')}</SelectItem>
